...
from utils import load_obj, rasterio_open, rasterio_get_sizes, rasterio_get_descriptors, SampleShape
from data.tiling_strategy import TilingStrategyDummy
...
class LocationDataset(TiledDataset):
    def __init__(self,
                 ...
                 tiling_strategy_cls: str = 'tiling_strategy.TilingStrategyDummy',
...
class SingleFolderImageDataset(TiledDataset):
    ...
    def __init__(self,
                 ...
                 filter_cls: str = 'filters.NoFilter',
                 filter_args: Dict = {},
                 normaliser_cls: str = 'normalisers.NoNormaliser',
